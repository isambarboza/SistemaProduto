...
namespace SistemaProduto.Controllers
{
    public class FornecedorController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,FornecedorNome,EmailDoFornecedor,CnpjDoFornecedor")] Fornecedor fornecedor)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,FornecedorNome,EmailDoFornecedor,CnpjDoFornecedor")] Fornecedor fornecedor)
        {
            if (id != fornecedor.Id)
            {
                return NotFound();
