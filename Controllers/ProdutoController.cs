...
namespace SistemaProduto.Controllers
{
    public class ProdutoController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,ProdutoNome,ProdutoEstoque,TipoProdutoId,FornecedorId")] Produto produto)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,ProdutoNome,ProdutoEstoque,TipoProdutoId,FornecedorId")] Produto produto)
        {
            if (id != produto.Id)
            {
                return NotFound();
